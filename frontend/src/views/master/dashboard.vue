...
<template>
  <div class="w-screen h-screen flex">
    <!-- Side bar -->
    <div
      class="flex flex-col h-full p-3 w-60 dark:bg-gray-900 dark:text-gray-100"
    >
      <div class="space-y-3">
        ...
        <div class="relative">
          ...
          <input
            ...
            name="Search"
            placeholder="Search..."
            class="w-full py-2 pl-10 text-sm dark:border-transparent rounded-md focus:outline-none dark:bg-gray-800 dark:text-gray-100 focus:dark:bg-gray-900"
          />
        </div>
        <div class="flex-1">
          ...
          <div class="w-[calc(100%-200px)] flex justify-center">
            ...
            <form class="flex items-center w-[500px]">
              ...
              <div class="relative w-full">
                <input
                  type="text"
                  class="bg-white border border-neutral-600 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
          ...
          <div class="w-[200px]">
            ...
            >
              ...
              <img
                ...
                alt="teste"
              />
              <div class="font-semibold text-neutral-900 text-left">
                <div>{{ username }}</div>
