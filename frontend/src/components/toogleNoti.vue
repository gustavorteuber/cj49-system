<template>
  <div class="relative flex">
    <div class="dropdown">
      <button class="dropbtn" @click="toggleMenu">Dropdown</button>
          ...
          <div class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            >
              <div class="flex-shrink-0">
                ...
                />
                <div
                  class="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-gray-600 border border-white rounded-full dark:border-gray-800"
                >
                  <svg
                    class="w-3 h-3 text-white"
                    aria-hidden="true"
            ...
            >
              <div class="flex-shrink-0">
                ...
                />
                <div
                  class="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-gray-500 border border-white rounded-full dark:border-gray-800"
                >
                  <svg
                    class="w-3 h-3 text-white"
                    aria-hidden="true"
